...
then
    ...
    OUTPUT_SCRIPT="/opt/quorum/bin/public-contract-test-sender.js"
else
    OUTPUT_SCRIPT=$1
fi
...
var simple = simpleContract.new(42, {from:eth.coinbase, data: simpleCompiled, gas: 300000}, simpleCallback);
EOF
