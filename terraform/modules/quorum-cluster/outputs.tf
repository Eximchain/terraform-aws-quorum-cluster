output "quorum_maker_node_dns" {
  value = {
    ...
    eu-west-2      = "${module.quorum_cluster_eu_west_1.quorum_maker_node_dns}"
...
output "quorum_validator_node_dns" {
  value = {
    ...
    eu-west-2      = "${module.quorum_cluster_eu_west_1.quorum_validator_node_dns}"
...
output "quorum_observer_node_dns" {
  value = {
    ...
    eu-west-2      = "${module.quorum_cluster_eu_west_1.quorum_observer_node_dns}"
...
output "bootnode_dns" {
  value = {
    ...
    eu-west-2      = "${module.quorum_cluster_eu_west_1.bootnode_dns}"
